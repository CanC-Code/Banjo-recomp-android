...
def fix_n64_types():
    ...
    Restores all exact N64 memory layouts and structures, wrapped in cooperative 
    BKA guards to prevent sister-script redefinitions.
    """
...
"""
    ...
    print("✅ n64_types.h updated: Fully restored all structural elements with cooperative patching guards.")
