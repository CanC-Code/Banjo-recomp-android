...
logger = logging.getLogger("N64_RECOMP_PHASE2")
...
try:
    ...
    # Expanded macros for Phase 2 I/O operations
    KNOWN_MACROS = {
...
# (Includes advanced structs for DevMgr and I/O Messages)
# ---------------------------------------------------------------------------
